...
<div class=" space-y-5">
  <div class="card">
    <header class=" card-header noborder">
      <h4 class="card-title">{$_L['Order_History']} </h4>
    </header>
              ...
              <thead class=" bg-slate-200 dark:bg-slate-700">
                ...
                <tr>
                  ...
                  <td class="table-td "> {if $ds['status']==1} <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-warning-500
                              bg-warning-500">{$_L['UNPAID']}</div> {elseif $ds['status']==2} <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-success-500
                            bg-success-500">{$_L['PAID']}</div> {elseif $ds['status']==3} <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-secondary-500
                              bg-secondary-500">{$_L['FAILED']}</div> {elseif $ds['status']==4} <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-danger-500
                              bg-danger-500">{$_L['CANCELED']}</div> {elseif $ds['status']==5} <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-primary-500
                              bg-primary-500">{$_L['UNKNOWN']}</div> {/if} </td>
                  <td class="table-td ">
