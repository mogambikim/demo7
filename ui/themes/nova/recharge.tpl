...
<div class="row">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <select {if $cust}{else} id="personSelect" {/if} class="form-control select2" name="id_customer" style="width: 100%" data-placeholder="{$_L['Select_Customer']}...">
                {if $cust}
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <label><input type="radio" id="Static" name="type" value="Static"> {$_L['Static_IP_Plans']}</label>
        </div>
    </div>
    <div class="form-group">
