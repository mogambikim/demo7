...
$_L['Welcome_Text_Admin'] = '<b>FreeIspRadius</b> is a billing Hotspot, Static and PPPOE for Mikrotik using PHP and Mikrotik API to comunicate with router. If you get more profit with this application, please donate us.<br>Watch project <a href="https://freeispradius.com" target="_blank">in here</a>';
...
$_L['Buy_this_your_active_package_will_be_overwrite'] = 'Buy Package ? Your active package will be overwritten! After clicking OK kindly give up to 30 seconds for your account to be activated.You will be redirected to home page after a succesful payment and activation';
...
$_L['Pay_this_with_Balance_your_active_package_will_be_overwrite'] = 'Pay Package with Balance? Your active package will be overwritten! After clicking OK Kindly give up to 30 Sec for your account to be activated.You will be redirected to home page after a succesful payment and activation';
...
$_L['Create_Transaction_Success_Please_check_your_phone_to_process_payment'] = 'Create Transaction Success, Please check your phone to process payment';
$_L['Cancel_the_order'] = 'Cancel the order?';
$_L['Expired'] = 'Expired';
$_L['Backup_Database'] = 'Backup Database';
$_L['Backup_not_found'] = 'Backup not found.';
$_L['Captive_Portal_Slider'] = 'Captive Portal Slider';
$_L['Slider_not_found'] = 'Slider not found.';
$_L['Are_you_Sure_you_want_to_Delete_this_Slider'] = 'Are you Sure you want to Delete this Slider?';
$_L['Customization'] = 'Customization';
$_L['Slider_Settings'] = 'Slider Settings';
$_L['Advertisement_Settings'] = 'Advertisement Settings';
$_L['Trial_Authorization_Settings'] = 'Trial Authorization Settings';
$_L['Pages_Settings'] = 'Pages Settings';
$_L['Allow_Free_Trial'] = 'Allow Free Trial';
$_L['Allow_Member_Login'] = 'Allow Member Login';
$_L['Edit_Static_Plan'] = 'Edit Static Plan';
