            ...
            if ($radius_enable) {
                try {
                    ...
                    $ui->assign("error_message", "Radius table not found.<br><br>" .
                        $e->getMessage() .
                        "<br><br>Download <a href=\"https://raw.githubusercontent.com/Gomez1996/mikrotik/install/radius.sql\">here</a> or <a href=\"https://raw.githubusercontent.com/Gomez1996/mikrotik/install/radius.sql\">here</a> and import it to database.<br><br>Check config.php for radius connection details");
