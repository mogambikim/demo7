...
$htmlContent .= "                    \n";
$htmlContent .= "                    // Set the paymentSubmitted flag in localStorage\n";
...
$htmlContent .= "        var paymentSubmitted = localStorage.getItem('paymentSubmitted');\n";
$htmlContent .= "        var paymentSubmittedExpiration = localStorage.getItem('paymentSubmittedExpiration');\n";
